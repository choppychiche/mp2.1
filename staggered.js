...
let shop = document.getElementById('shop5');
...
let generateShop =() => {
    return (shop.innerHTML = shopItemsData
        ...
        <div id=product-id-${id} class="card" style="width: 13rem; margin-left: 15%;">
            <img src="images/ww1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h3> ${name} </h3>
